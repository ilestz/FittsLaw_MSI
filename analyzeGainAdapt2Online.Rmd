...
df.all = fromJSON(file = "gain-online_e2.json")
c=1
for(s in 1:numsubs){
...
if(save_figs){
  write.csv(type_sub, "E4B_MTs.csv")
}
```
...
if(save_figs){
  write.csv(sub_hit, "E4B_hit_train.csv")
  write.csv(sub_lc, "E4B_lc_train.csv")
}
...
if(save_figs){
  write.csv(model_fits, "E4B_modelfits.csv")
}
...
```
```{r}
demographics = read.csv("e3online_demo.csv")
#demo2 = read.csv("e2online_demo2.csv")
#demographics = rbind(demographics, demo2)
...
write.csv(demographics, "e4Bonline_included.csv")
```
